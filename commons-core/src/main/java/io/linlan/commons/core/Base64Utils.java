...
import io.linlan.commons.core.codec.Base64Decoder;
import io.linlan.commons.core.codec.Base64Encoder;
 ...
 * Desc: Base64工具类，提供Base64的编码和解码方案<br>
...
public class Base64Utils {
    ...
    public static String encode(CharSequence source, String charset) {
        return encode(source, CharsetUtils.getCharset(charset));
    }
    ...
    public static String encodeUrlSafe(CharSequence source, String charset) {
        return encodeUrlSafe(source, CharsetUtils.getCharset(charset));
    }
    ...
    public static String encode(File file) {
        return Base64Encoder.encode(IoUtils.readBytes(file));
    }
    ...
    public static String decodeStr(CharSequence source, String charset) {
        return decodeStr(source, CharsetUtils.getCharset(charset));
    }
    ...
    public static File decodeToFile(CharSequence base64, File destFile) {
        return IoUtils.writeBytes(Base64Decoder.decode(base64), destFile);
    }
