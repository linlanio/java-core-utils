 ...
 */
package io.linlan.commons.db;

import io.linlan.commons.core.CoreException;
import io.linlan.commons.core.StringUtils;

/**
 * this is the database exception of commons database package
...
public class DbException extends CoreException {
     ...
     * @param params params to input
     */
    public DbException(Throwable cause, String messageTemplate, Object... params) {
