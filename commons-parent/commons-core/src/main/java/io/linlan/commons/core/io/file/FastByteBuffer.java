...
/**
 * Fast ByteBuffer class to define buffer's operation
 * Filename:FastByteBuffer.java
 * Desc:Fast ByteBuffer to save stream byte in buffer
 * it can replace array, so the performance is high
 * it provide to OutputStream do operations.
 *
 * @author <a href="mailto:20400301@qq.com">linlan</a>
 * Createtime 2017/7/12 11:46 PM
 * 
 * @version 1.0
 * @since 1.0
 * 
