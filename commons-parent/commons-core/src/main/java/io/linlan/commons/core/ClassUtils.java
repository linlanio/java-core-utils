...
public abstract class ClassUtils {
     ...
     * as user-abs methods since they are eventually pointing to a user-declared generic method.
    ...
    public static <T> T newInstance(Class<T> clazz, Object... params) {
        if (ArrayUtils.isEmpty(params)) {
            try {
                ...
                throw new CoreException(StringUtils.format("Instance class [{}] error!", clazz), e);
            }
        }

        final Class<?>[] paramTypes = getClasses(params);
        final Constructor<?> constructor = getConstructorIfAvailable(clazz, paramTypes);
        if(null == constructor){
            throw new CoreException("No Constructor matched for parameter types: [{}]", new Object[]{paramTypes});
        }
        try {
    ...
    /**
     * get the source relative resource URL
     * if clazz is not null, use {@link Class#getResource}
     * else use {@link ClassLoader#getResource}
     *
     * @param source relative path of resource
     * @param clazz base clazz, get the base clazz, if {@code null}, use classpath
     * @return {@link URL}
     */
    ...
    public static String getClassPath() {
        URL uri = getUrl(StringUtils.EMPTY, null);
        return uri.getPath();
    }
